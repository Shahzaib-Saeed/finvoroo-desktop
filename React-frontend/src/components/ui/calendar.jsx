...
function CalendarNavDropdown({
  ...
  return (
    ...
    >
      <SelectTrigger
        size="sm"
        className={cn('h-8 w-auto shrink-0 font-medium', className)}
      >
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: 'w-full',
        month_caption:
          'relative mb-1 flex h-9 w-full items-center justify-center px-10 z-20',
        caption_label: 'text-sm font-medium',
        dropdowns: 'flex w-full items-center justify-center gap-2',
        months_dropdown: 'min-w-[7.25rem]',
        years_dropdown: 'min-w-[5.25rem]',
