...
export const ROUTE_PERMISSIONS = [
  ...
  { pattern: '/workspace/:id/pharmacy/investors', permission: 'investors.view' },
  {
    pattern: '/workspace/:id/pharmacy/investors/:investmentId/distribution',
    permission: 'investors.view',
  },
  { pattern: '/workspace/:id/pharmacy/expense-allocation', permission: 'investors.edit' },
  ...
  { pattern: '/workspace/:id/pharmacy/reports/employee-sales', permission: 'reports.view' },
